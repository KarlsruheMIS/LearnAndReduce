...
private:
    ...
    // void fold(branch_and_reduce_algorithm *br_alg, fold_nodes &nodes, NodeWeight MWIS_weight);
    void fold(branch_and_reduce_algorithm *br_alg, fold_nodes &nodes, NodeWeight MWIS_weight, std::vector<NodeID> &excluded_nodes);
