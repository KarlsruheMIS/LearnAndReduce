...
int main(int argn, char **argv)
{
    ...
    {
        if (config.solution_from_file)
        {
            std::cout << "Please give the path to a solution for the reduced graph ... " << std::endl;
    ...
    if (g.number_of_nodes() == 0 || computed_reduced_solution)
    {
        ...
        // check solutoin weight correctness:
        // NodeWeight check_weight = 0;
        // for (NodeID n = 0; n < G.number_of_nodes(); n++)
        // {
        //     if (full_solution[n])
        //     {
        //         forall_out_edges(G,e,n)
        //         {
        //             if (full_solution[G.getEdgeTarget(e)])
        //             {
        //                 std::cout << "ERROR: solution is not independent." << std::endl;
        //                 return;
        //             }
        //         } endfor
        //         check_weight += G.getNodeWeight(n);
        //     }
        // }
        // std::cout << "checked final solution weight is \t\t" << check_weight <<  std::endl;
