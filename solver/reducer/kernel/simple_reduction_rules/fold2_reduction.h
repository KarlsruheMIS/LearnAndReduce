...
struct fold2_reduction : public general_reduction
{
    ...
    virtual std::string get_reduction_name() final { return "degree_2"; }
...
private:
    ...
    void fold_triangle_mid_weight(reduce_algorithm *br_alg, const fold_nodes &nodes);
    void fold_triangle_min_weight(reduce_algorithm *br_alg, const fold_nodes &nodes);
    void fold_v_shape_max_weight(reduce_algorithm *br_alg, const fold_nodes &nodes);
    void fold_v_shape_mid_weight(reduce_algorithm *br_alg, const fold_nodes &nodes);
    void fold_v_shape_min_weight(reduce_algorithm *br_alg, const fold_nodes &nodes);
