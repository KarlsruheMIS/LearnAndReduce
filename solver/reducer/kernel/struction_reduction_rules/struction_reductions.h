...
struct iterative_struction : public general_reduction
{
    ...
    virtual void restore(reduce_algorithm *r_alg) final { s.restore(r_alg); };
    virtual void apply(reduce_algorithm *r_alg) final { s.apply(r_alg); };
...
struct blow_up_struction : public general_reduction
{
    ...
    virtual bool reduce(reduce_algorithm *r_alg) final;
    // virtual bool reduce_vertex(reduce_algorithm* r_alg, NodeID v) final;
    virtual void restore(reduce_algorithm *r_alg) final;
    virtual void apply(reduce_algorithm *r_alg) final { s.apply(r_alg); };
    virtual void reset(reduce_algorithm *r_alg, size_t comp_size) final;
