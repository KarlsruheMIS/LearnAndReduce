...
bool clique_neighborhood_reduction::reduce(reduce_algorithm *br_alg)
{
...
inline bool clique_neighborhood_reduction::reduce_vertex(reduce_algorithm *br_alg, NodeID v)
{
    // if (br_alg->config.disable_clique_neighborhood) return false;
    auto &status = br_alg->status;
    size_t oldn = status.remaining_nodes;
...
bool clique_neighborhood_reduction::partition_into_cliques(NodeID v, reduce_algorithm *br_alg)
{
...
bool clique_neighborhood_reduction::expand_clique(NodeID max_neighbor, std::vector<NodeID>& neighbors_vec, fast_set& clique_neighbors_set, reduce_algorithm* br_alg) {
	auto& status = br_alg->status;
